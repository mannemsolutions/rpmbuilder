...
Source0: etcd-v3.4.20-linux-amd64.tar.gz
BuildArch: x86_64
...
%prep
curl -L https://github.com/etcd-io/etcd/releases/download/v3.4.20/etcd-v3.4.20-linux-amd64.tar.gz -o %{_sourcedir}/etcd-v3.4.20-linux-amd64.tar.gz
